...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='地址管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜品及套餐分类';
...
CREATE TABLE `dish` (
                        `id` bigint(20) NOT NULL COMMENT '主键',
                        `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '菜品名称',
                        `category_id` bigint(20) NOT NULL COMMENT '菜品分类id',
                        `price` decimal(10,2) DEFAULT NULL COMMENT '菜品价格',
                        `code` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品码',
                        `image` varchar(200) COLLATE utf8mb4_general_ci NOT NULL COMMENT '图片',
                        `description` varchar(400) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '描述信息',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜品管理';
...
CREATE TABLE `dish_flavor` (
                               ...
                               `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '口味名称',
                               `value` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '口味数据list',
                               `create_time` datetime NOT NULL COMMENT '创建时间',
                               `update_time` datetime NOT NULL COMMENT '更新时间',
                               `create_user` bigint(20) NOT NULL COMMENT '创建人',
                               `update_user` bigint(20) NOT NULL COMMENT '修改人',
                               `is_deleted` int(11) NOT NULL DEFAULT '0' COMMENT '是否删除',
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜品口味关系表';
...
CREATE TABLE `employee` (
                            ...
                            `phone` varchar(11) COLLATE utf8mb4_general_ci NOT NULL COMMENT '手机号',
                            `sex` varchar(2) COLLATE utf8mb4_general_ci NOT NULL COMMENT '性别',
                            `id_number` varchar(18) COLLATE utf8mb4_general_ci NOT NULL COMMENT '身份证号',
...
CREATE TABLE `orders` (
                          `id` bigint(20) NOT NULL COMMENT '主键',
                          `number` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '订单号',
...
CREATE TABLE `order_detail` (
                                ...
                                `dish_flavor` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '口味',
...
CREATE TABLE `setmeal` (
                           ...
                           `description` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '描述信息',
...
CREATE TABLE `setmeal_dish` (
                                `id` bigint(20) NOT NULL COMMENT '主键',
                                `setmeal_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '套餐id ',
                                `dish_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '菜品id',
                                `name` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜品名称 （冗余字段）',
                                ...
                                `is_deleted` int(11) NOT NULL DEFAULT '0' COMMENT '是否删除',
                                PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='套餐菜品关系';
...
CREATE TABLE `user` (
                        ...
                        `phone` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '手机号',
